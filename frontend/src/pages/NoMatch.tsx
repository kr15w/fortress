			...
			<div className="w-full max-w-md px-4">
				<Card className="border border-border bg-card text-card-foreground shadow-md">
					...
					<CardContent className="text-center space-y-6">
								...
								<img
									...
									onError={(e) => {
										...
										const options = [
											...
											"https://cdn.discordapp.com/attachments/1156500024478412842/1371515046265487472/image.png?ex=68236a6c&is=682218ec&hm=0af9807d17c4e8c36d00a6371813d376adc1434dc0792b248c78724b9812c4df&",
										];
										target.src =
						...
						<br></br>
						<p className="text-muted-foreground mt-[20px]">
