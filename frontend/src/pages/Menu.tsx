      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data && data.length > 0) {
            ...
            const username = decryptUsername(sessionStorage.getItem("currentUser"))
      ...
      <div className="w-full max-w-4xl px-4">
        <Card className="border border-border bg-card text-card-foreground shadow-md overflow-hidden">
          ...
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-center">Choose your next adventure</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-8 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Button
                ...
                asChild
              >
                <Link to="/game" className="flex items-center justify-center gap-3">
                  <PlayCircle className="h-6 w-6" />
                  <span className="text-lg font-semibold text-white">Start a Game</span>
                </Link>
              </Button>
              ...
              >
                <Link to="/game" className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-lg font-semibold text-white">Join a Game</span>
                </Link>
              </Button>
            </div>
